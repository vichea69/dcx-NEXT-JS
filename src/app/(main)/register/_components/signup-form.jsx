        ...
        <form onSubmit={onSubmit} >
          <div className="grid gap-4">
            ...
            <Button
              ...
              onClick={() => {
                console.log('[SignupForm] role prop:', role);
                const intended = (role === 'instructor' || role === 'student') ? role : 'student';
                console.log('[SignupForm] intended role to set in cookie:', intended);
                document.cookie = `registerRole=${intended}; path=/; max-age=600`;
                console.log('[SignupForm] document.cookie after setting registerRole:', document.cookie);
